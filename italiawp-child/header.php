    ...
    <?php } ?>
        ...
        <div class="Header-banner" id="Header-banner">
            <div class="Header-owner Headroom-hideme ">
                <a href="<?php echo get_theme_mod('dettagli-url-ammin-afferente'); ?>"  target="_self" title="Vai al sito <?php echo get_theme_mod('dettagli-nome-ammin-afferente');?>">
                	<span>
            <?php if(get_theme_mod('dettagli-logo-ammin-afferente')!=""){
            	...
            	$logo = esc_url($logo[0]);?>
            		<img class="custom-logo" alt="Logo " itemprop="logo" src="<?php echo $logo;?>">
            		</span>
            	</a>
            <?php }
            else{
                ...
                <div class="Header-logo Grid-cell" aria-hidden="true">
                    ...
                    <?php
                        ...
                        if (has_custom_logo()) {
                            ...
                            $custom_logo = get_stylesheet_directory_uri() . '/img/stemma-default.png';
                        } ?>
...
<?php
	$Facebook=get_option('dettagli-facebook');
	$Twitter=get_option('dettagli-twitter');
	$YouTube=get_option('dettagli-youtube');
	$Instagram=get_option('dettagli-instagram');
	if($Facebook!="" or $Twitter!="" or $YouTube!="" or $Instagram=""){?>                    <div class="Header-social Headroom-hideme">
                        <p>Seguici su</p>
                        <ul class="Header-socialIcons">
                        <?php if($Facebook!=""): ?>
                            <li><a target="_blank" title="Facebook" href="<?php echo $Facebook; ?>"><span class="Icon-facebook"></span><span class="u-hiddenVisually">Facebook</span></a></li>
                        <?php endif; ?>
                        <?php if($Twitter!=""): ?>
                            <li><a target="_blank" title="Twitter" href="<?php echo $Twitter; ?>"><span class="Icon-twitter"></span><span class="u-hiddenVisually">Twitter</span></a></li>
                        <?php endif; ?>
                        <?php if($YouTube!=""): ?>
                            <li><a target="_blank" title="YouTube" href="<?php echo $YouTube; ?>"><span class="Icon-youtube"></span><span class="u-hiddenVisually">Youtube</span></a></li>
                        <?php endif; ?>
                        <?php if($Instagram!=""): ?>
                            <li><a target="_blank" title="Instagram" href="<?php echo $Instagram; ?>"><span class="Icon-instagram"></span><span class="u-hiddenVisually">Instagram</span></a></li>
                        <?php endif; ?>
                        </ul>
                    </div>
<?php		
...
?>
        ...
        <div class="u-textCenter u-hidden u-sm-hidden u-md-block u-lg-block">
            <nav id="MainMenu" class="Megamenu Megamenu--default js-megamenu " data-rel=".Offcanvas .Treeview"></nav>
        </div>
...
if(!is_front_page()){
	if(function_exists('bcn_display_list')){        
		get_template_part( 'template-parts/breadcrumbs' );
			...
			if(!is_attachment()) italiawp_create_breadcrumbs();
		}
}?>